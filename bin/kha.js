...
var RectPack2Demo = function() {
	...
	this.blocks = [];
	this.busy = false;
	haxe_Log.trace("new RectPackDemo",{ fileName : "RectPack2Demo.hx", lineNumber : 58, className : "RectPack2Demo", methodName : "new"});
...
RectPack2Demo.main = function() {
	haxe_Log.trace("main started",{ fileName : "RectPack2Demo.hx", lineNumber : 48, className : "RectPack2Demo", methodName : "main"});
...
RectPack2Demo.prototype = {
	...
	,loadAll: function() {
		haxe_Log.trace("load all ",{ fileName : "RectPack2Demo.hx", lineNumber : 63, className : "RectPack2Demo", methodName : "loadAll"});
		this.khaImages.showImage = true;
		this.khaImages.showLabel = true;
		this.khaImages.showBackColor = true;
		this.khaImages.showCross = true;
	...
	,render: function(framebuffer) {
		...
		case 0:
			...
			this.khaImages.colorIndex = this.lastColorIndex;
			haxe_Log.trace("texture pack file:\n " + this.tp.write(),{ fileName : "RectPack2Demo.hx", lineNumber : 212, className : "RectPack2Demo", methodName : "drawImageSheet"});
			break;
		case 1:
...
kha_Shaders.init = function() {
	...
	var data8 = Reflect.field(kha_Shaders,"painter_image_vertData" + 2);
	...
	var data20 = Reflect.field(kha_Shaders,"painter_video_vertData" + 2);
